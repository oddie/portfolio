export const profileLinks = [{
    url: 'https://github.com/oddie', title: 'GitHub',
}, {
    url: 'https://www.linkedin.com/in/ovkovalev', title: 'LinkedIn'
}, {
    url: 'https://www.facebook.com/oleg.kovalev', title: 'Facebook'
}];
...
export const projects = [{
    ...
    url: '',
    gallery: ['pzz_1.png', 'pzz_2.png', 'pzz_3.png']
}, {
    title: 'Tokpie',
    ...
    url: 'https://tokpie.io',
    gallery: ['tokpie_1.png', 'tokpie_2.png']
}, {
    title: 'TokenListed',
    ...
    description: `Website for a drive-through cafe network.`,
    stack: 'Wordpress, Mysql',
    urlTitle: 'Check the website: https://c-machine.ru/',
    url: 'https://c-machine.ru/',
    gallery: ['cmachine_1.png', 'cmachine_2.png', 'cmachine_3.png', 'cmachine_4.png']
}, {
    title: 'Arcada Art',
    description: `Website for a real estate developer.`,
    stack: 'Wordpress, Mysql',
    urlTitle: 'Check the website: https://arcada-art.ru/',
    url: 'https://arcada-art.ru/',
    gallery: ['arcada_1.png']
}, {
    title: 'Perspective',
    description: `Website for a real estate developer.`,
    stack: 'Wordpress, Mysql',
    urlTitle: 'Check the website: https://szdvs.ru/',
    url: 'https://szdvs.ru/',
    gallery: ['szdvs_1.png']
}, {
    title: 'Sea Wolf Movies',
    description: `Website for a movie company.`,
    stack: 'Wordpress, Mysql',
    urlTitle: 'Check the website: http://seawolf-csc.ru/',
    url: 'http://seawolf-csc.ru/',
    gallery: ['seawolf_1.png']
}, {
    title: 'Russtroy Consulting',
    description: `Corporate website for a construction engineering company.`,
    stack: 'Wordpress, Mysql',
    urlTitle: 'Check the website: http://rs-consulting.ru/',
    url: 'http://rs-consulting.ru/',
    gallery: ['rsc_1.png', 'rsc_2.png', 'rsc_3.png']
}, {
    title: 'Reggio MD',
    description: `Website for a children's club.`,
    stack: 'Wordpress, Mysql',
    urlTitle: 'Check the website: http://reggiomd.ru/',
    url: 'http://reggiomd.ru/',
    gallery: ['reggio_1.png']
}, {
    title: 'DiverSaint',
    description: `Website for a scuba diving club.`,
    stack: 'Wordpress, Mysql',
    urlTitle: 'Check the website: https://diversaint.com/',
    url: 'https://diversaint.com/',
    ...
    title: 'Remi Mall Promo',
    description: `Two websites for marketing promo actions.`,
    stack: 'Wordpress, Mysql',
    urlTitle: 'Closed by the owner. Screenshots are not available.',
    url: '',
    gallery: []
    ...
    title: 'Adimi Group',
    description: `Two websites for a construction tools seller.`,
    stack: 'Wordpress, Mysql',
    urlTitle: 'Closed by the owner. Screenshots are not available.',
    url: '',
    gallery: []
}, {
    title: 'Aqua25 Engineering',
    description: `Website for an engineering company.`,
    stack: 'Wordpress, Mysql',
    urlTitle: 'Closed by the owner. Screenshots are not available.',
    url: '',
    gallery: []
    ...
    title: 'Salon Personnel',
    description: `Simple HR web application for a beauty salon.`,
    stack: 'Laravel, Mysql',
    urlTitle: 'Closed by the owner. Screenshots are not available.',
    url: '',
    gallery: []
    ...
    title: 'Igropolis',
    description: `Website for a game develper company.`,
    stack: 'Wordpress, Mysql',
    urlTitle: 'Closed by the owner. Screenshots are not available.',
    url: '',
    gallery: []
